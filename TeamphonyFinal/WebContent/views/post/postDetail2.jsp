			...
			<form action="${pageContext.request.contextPath}/post/revise.do"
				...
				<table class="table">
					...
					<tbody>
						...
						<tr id="videoView" hidden="true">
							<th>영상</th>
							<td>
								<div id="player"></div> <input type="text"
								name="videoLink" id="videoLink" value="${post.videoLink}">
							</td>
						</tr>
						<tr id="imageView" hidden="true">
							<th>이미지</th>
							<td><img src="${post.imagePath}"> <input type="text"
								id="imagePath" name="imagePath" value="${post.imagePath}">
							</td>
						</tr>
						<tr id="fileView" hidden="true">
							<th>첨부파일</th>
							<td><input type="file" id="filePath" name="filePath"
								value="${post.filePath }"><input type="text"
								value="${post.filePath}"></td>
						</tr>
					</tbody>
				</table>
				<br>
