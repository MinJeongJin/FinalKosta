...
<body>
	...
	<form>
		<table class="table">
			...
			<tr>
				<th>제목</th>
				<td><label for="submissionTitle" name="submissionTitle"
			...
			<tr>
				<th>내용</th>
				<td><label for="submissionContents" name="submissionContents"
						class="form-control" rows="7" >${task.contents } 내용 입니다.</label></td>
			</tr>
		</table>
		<br>
		<div align="center">
			<a href="submissionModify.do?taskId=${task.id}"><input class="btn" type="reset" value="수정"></a> 
			<a href="submissionErase.do?taskId=${task.id} "><input class="btn btn-success" type="submit" value="삭제"></a>
		</div>
	</form>
	<br>
</body>
