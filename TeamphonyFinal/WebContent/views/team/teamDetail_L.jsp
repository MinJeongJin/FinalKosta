			...
			<form id="detailForm" method="post"
				...
				<div class="w3-row">
					...
					<div id="selectBtnGr" class="w3-right">
						...
						<button class="w3-btn w3-large w3-dark-grey" type="button"
							onclick="document.getElementById('removeAlert').style.display='block';">삭제</button>
						<button type="button" class="w3-btn w3-large w3-dark-grey"
					...
					<div id="reviseBtnGr" class="w3-right" hidden="true">
						...
						<button type="button" class="w3-btn w3-large w3-dark-grey"
							onclick="document.getElementById('reviseAlert').style.display='block';">확인</button>
						<button class="w3-btn w3-large w3-dark-grey">
