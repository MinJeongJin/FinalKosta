...
.starPoint>.input, .starPoint>.input>label:hover, .starPoint>.input>input:focus+label,
	.starPoint>.input>input:checked+label {
...
.starPoint>.input.focus {
	outline: 1px dotted #ddd;
}

.starPoint>.input>label {
	width: 10px;
	height: 0;
	padding: 19px 0 0 0;
	overflow: hidden;
...
.starPoint>.input>label:hover, .starPoint>.input>input:focus+label,
	.starPoint>.input>input:checked+label {
	background-size: 100px;
			...
			<form
				...
				<table>
					...
					<tbody>
						<tr>
							<td>성실성</td>
							<td><span class="starPoint"> <span class="input">
										<input type="radio" name="sincerity" id="p1-1" value="1"><label
										for="p1-1">1</label> <input type="radio" name="sincerity"
										id="p2-1" value="2"><label for="p2-1">2</label> <input
										type="radio" name="sincerity" id="p3-1" value="3"><label
										for="p3-1">3</label> <input type="radio" name="sincerity"
										id="p4-1" value="4"><label for="p4-1">4</label> <input
										type="radio" name="sincerity" id="p5-1" value="5"><label
										for="p5-1">5</label> <input type="radio" name="sincerity"
										id="p6-1" value="6"><label for="p6-1">6</label> <input
										type="radio" name="sincerity" id="p7-1" value="7"><label
										for="p7-1">7</label> <input type="radio" name="sincerity"
										id="p8-1" value="8"><label for="p8-1">8</label> <input
										type="radio" name="sincerity" id="p9-1" value="9"><label
										for="p9-1">9</label> <input type="radio" name="sincerity"
										id="p10-1" value="10"><label for="p10-1">10</label>
								</span>
							</span></td>
						</tr>
						<tr>
							<td>기여도</td>
							<td><span class="starPoint"> <span class="input">
										<input type="radio" name="contribution" id="p1-2" value="1"><label
										for="p1-2">1</label> <input type="radio" name="contribution"
										id="p2-2" value="2"><label for="p2-2">2</label> <input
										type="radio" name="contribution" id="p3-2" value="3"><label
										for="p3-2">3</label> <input type="radio" name="contribution"
										id="p4-2" value="4"><label for="p4-2">4</label> <input
										type="radio" name="contribution" id="p5-2" value="5"><label
										for="p5-2">5</label> <input type="radio" name="contribution"
										id="p6-2" value="6"><label for="p6-2">6</label> <input
										type="radio" name="contribution" id="p7-2" value="7"><label
										for="p7-2">7</label> <input type="radio" name="contribution"
										id="p8-2" value="8"><label for="p8-2">8</label> <input
										type="radio" name="contribution" id="p9-2" value="9"><label
										for="p9-2">9</label> <input type="radio" name="contribution"
										id="p10-2" value="10"><label for="p10-2">10</label>
								</span>
							</span></td>
						</tr>
						<tr>
							<td>태도</td>
							<td><span class="starPoint"> <span class="input">
										<input type="radio" name="attitude" id="p1-3" value="1"><label
										for="p1-3">1</label> <input type="radio" name="attitude"
										id="p2-3" value="2"><label for="p2-3">2</label> <input
										type="radio" name="attitude" id="p3-3" value="3"><label
										for="p3-3">3</label> <input type="radio" name="attitude"
										id="p4-3" value="4"><label for="p4-3">4</label> <input
										type="radio" name="attitude" id="p5-3" value="5"><label
										for="p5-3">5</label> <input type="radio" name="attitude"
										id="p6-3" value="6"><label for="p6-3">6</label> <input
										type="radio" name="attitude" id="p7-3" value="7"><label
										for="p7-3">7</label> <input type="radio" name="attitude"
										id="p8-3" value="8"><label for="p8-3">8</label> <input
										type="radio" name="attitude" id="p9-3" value="9"><label
										for="p9-3">9</label> <input type="radio" name="attitude"
										id="p10-3" value="10"><label for="p10-3">10</label>
								</span>
							</span></td>
						</tr>
					</tbody>
