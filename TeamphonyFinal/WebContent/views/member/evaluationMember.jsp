...
.star-input>.input,
.star-input>.${member.memberId}>label:hover,
...
<body class="nav-md">
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="container" id="teamManage">
					<h2 id="menuTitle">팀원 평가</h2>
					<form id="memberEvalution" method="POST" action="${pageContext.request.contextPath}/member/evaluation.do">		
						<div class="row">
							<div class="form-group col-xs-7">
								<label for="contents">별명 : ${member.alias}</label>
						...
						<div class="row">
							<div class="form-group col-xs-7">
								<label for="contents">지금 까지의 평점 :  <span class="stars">${member.starPoint}</span></p></label>
								<textarea class="form-control input-lg" name="contents"
									id="contents" style="width: 675px; height: 300px;"></textarea>
							</div>
						</div>
						...
						<button type="submit">평가 하기</button>
					</form>
				</div>
				<!-- /page content -->
				<!-- footer content -->
	...
	var starRating = function(){
	  ...
	  var starPoint = document.document.getElementById("starPoint")
	  $(document)
