...
<html lang="UTF-8">
	...
	<head>
		...
		<style type="text/css">
			...
			.starPoint>.input,
			.starPoint>.input>label:hover,
			.starPoint>.input>input:focus+label,
			...
			span.stars, span.stars span {
				display: block;
				background: url(${pageContext.request.contextPath}/resources/images/stars.png) 0 -16px repeat-x;
				width: 80px;
				height: 16px;
			}
						...
						<form action="${pageContext.request.contextPath}/member/evaluation.do" Method="post">
							...
							<div class="row">
								<div class="form-group col-xs-7">
									...
									<a href="${pageContext.request.contextPath}/member/evaluationList.do" class="btn btn-danger btn-lg">뒤로</a>
								</div>
							</div>
						</form>
					</div>
